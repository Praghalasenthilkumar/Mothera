  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "h2":      ["1.5rem", { lineHeight: "2rem",   fontWeight: "700", letterSpacing: "-0.01em" }],
        ...
        "label":   ["0.6875rem",{lineHeight:"1rem",   fontWeight: "600", letterSpacing: "0.04em" }],
      },
      boxShadow: {
        xs:       "0 1px 2px 0 rgba(0,0,0,0.05)",
        subtle:   "0 1px 4px rgba(0, 0, 0, 0.06), 0 0 1px rgba(0, 0, 0, 0.04)",
        card:     "0 4px 12px rgba(0, 0, 0, 0.08), 0 1px 3px rgba(0, 0, 0, 0.04)",
        elevated: "0 12px 32px rgba(0, 0, 0, 0.10), 0 4px 10px rgba(0, 0, 0, 0.06)",
        float:    "0 20px 40px rgba(0, 0, 0, 0.12), 0 8px 16px rgba(0, 0, 0, 0.06)",
